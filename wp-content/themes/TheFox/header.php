...
<div id="jpreOverlay" class="<?php echo esc_attr($rd_data['rd_loader_style']); ?> tf_complex_loader">
  ...
  <div class='thefox_bigloader'>
    ...
    <div class='thefox_loader_logo'>
      ...
      <!--<img src="https://alngroup-denislp1.c9users.io/wp-content/uploads/2016/05/ALN-circle.png"/>-->
      <?php } ?>
    </div>
    <div id="jprePercentage">0%</div>
  </div>
  <img class="pre_dummy_img" src="<?php echo get_template_directory_uri(); ?>/images/loader.gif"/></div>
  <!--<img class="pre_dummy_img" src="https://alngroup-denislp1.c9users.io/wp-content/uploads/2016/05/ALN-circle.png"/>-->
</div>
<?php } } 
