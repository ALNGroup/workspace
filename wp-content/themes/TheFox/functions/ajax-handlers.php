...
if( $post_format == 'quote' ){	
 ...
 ?>
  <div class="post_ctn"> 
    ...
    <div class="post-info"><?php echo __('By', 'thefoxwp'); ?> <?php the_author_posts_link(); ?>    |    <?php the_category(', '); ?>    |    <?php comments_popup_link(__('0 comment','thefoxwp'),__('1  comment','thefoxwp'),__('% comments','thefoxwp'),'comments-link',__('Comments are Closed','thefoxwp')); ?>    |    <?php the_time('j F, Y') ?>    |    <?php if( function_exists('zilla_likes') ){ echo zilla_likes();	}?></div>
...
<?php  echo rd_custom_excerpt('rd_port_long_excerpt','rd_trend_more'); ?>
    ...
    <?php the_author_posts_link(); if( function_exists('zilla_likes') ){ echo zilla_likes();	} ?>
    </div>
     </div>
     </div>
	</div>
...
if( $post_format == 'quote' ){	
 ...
 ?>
  <div class="post_ctn"> 
    ...
    <div class="post-info"><?php echo __('By', 'thefoxwp'); ?> <?php the_author_posts_link(); ?>    |    <?php the_category(', '); ?>    |    <?php comments_popup_link(__('0 comment','thefoxwp'),__('1  comment','thefoxwp'),__('% comments','thefoxwp'),'comments-link',__('Comments are Closed','thefoxwp')); ?>    |    <?php if( function_exists('zilla_likes') ){ echo zilla_likes();	}?></div>
...
if( $post_format == 'quote' ){	
 ...
 ?>
  <div class="post_ctn"> 
    ...
    <?php } ?>   
    <!-- .entry END --> 
    <div class="post-info"><a href="<?php the_permalink() ?>" title="<?php the_title(); ?>"><?php echo __('Read More','thefoxwp'); ?></a>    |    <?php comments_popup_link(__('0 comment','thefoxwp'),__('1  comment','thefoxwp'),__('% comments','thefoxwp'),'comments-link',__('Comments are Closed','thefoxwp')); ?>    |    <?php if( function_exists('zilla_likes') ){ echo zilla_likes();	}?></div>
 ...
 ?>
  <div class="post_ctn"> 
    ...
    <div class="post-title">
     ...
     <!-- .title END--> 
     <!-- post-info-top -->    
    <div class="post-info"><?php the_category(', '); ?>  |  <?php comments_popup_link(__('0 comment','thefoxwp'),__('1  comment','thefoxwp'),__('% comments','thefoxwp'),'comments-link',__('Comments are Closed','thefoxwp')); ?>  |  <?php if( function_exists('zilla_likes') ){ echo zilla_likes(); }?></div>
...
if ( $post_format !== 'quote' ) { ?>
    ...
    <?php } ?>
    <div class="post-bottom-info"><span class="info_comment"><?php comments_popup_link(__('0 comment','thefoxwp'),__('1  comment','thefoxwp'),__('% comments','thefoxwp'),'comments-link',__('Comments are Closed','thefoxwp')); ?>    |    </span><span class="info_like"><?php if( function_exists('zilla_likes') ){ echo zilla_likes();	}?></span></div></div>
